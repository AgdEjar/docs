...
1. Contact our support team at [md@agd.sa](mailto:md@agd.sa) to obtain API credentials
2. Review our [Getting Started guide](/api-reference/getting-started)
3. Try our [Postman Collection](https://documenter.getpostman.com/view/34108325/2sA3kd9GpM)
...
Contact our support team at [md@agd.sa](mailto:md@agd.sa) with:
